...
//
// swagger:parameters syncTagItems
type SyncTagItemsParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewSyncTagItemsParams() beforehand.
func (o *SyncTagItemsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SyncTagItemsParams) bindDate(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *SyncTagItemsParams) bindTag(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
